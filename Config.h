...
// The settings below are for initialization only, afterward they are stored and recalled from using EEPROM and must be changed
// in the web interface OR with a reset (for initialization again) as described below
